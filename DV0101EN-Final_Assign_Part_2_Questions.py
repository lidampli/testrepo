...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec, labels=exp_rec.index, autopct='%1.1f%%',
            values='Advertising_Expenditure', names='Vehicle_Type',
            title="total expenditure share by vehicle type during recessions"
            ))

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        bar_data= recession_data.groupby(['unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                bar_data,
                x='unemployment_rate',
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Yearly Automobile Sales over Recession Period"))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        month_data= yearly_data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(month_data, 
                x='Month',
                y='Automobile_Sales',
                title="Monthly Automobile Sales over Recession Period"))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, 
                 labels=exp_data.index, autopct='%1.1f%%',
                 values='Advertising_Expenditure', names='Vehicle_Type', 
                title="total expenditure share by vehicle type during recessions"
            ))
